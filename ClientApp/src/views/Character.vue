            ...
            <v-flex xs12 sm8>
                ...
                <div>
                        ...
                        <v-expansion-panel-content>
                            ...
                            <v-card>
                                <div>
                                    <class-skill
                                        v-for="(classSkill,
                                        index) in characterSelect.class
                                            .classSkills"
                                        :key="`cskill-${index}`"
                                        :classSkillIn="classSkill"
                                    ></class-skill>
                                </div>
                            </v-card>
                        </v-expansion-panel-content>
                    ...
                    <v-container>
                        <ability
                            v-for="(ability,
                            index) in characterSelect.abilityScores"
                            :key="`ability-${index}`"
                            :abilityIn="ability"
                        ></ability>
                    </v-container>
            ...
            <v-flex xs6>
                ...
                <div v-if="characters">
                    ...
                    >
                        ...
                        <v-btn
                            v-if="!characterUpdate"
                            v-on:click="selectUpdate(character)"
                            >Select</v-btn
                        >
                        <v-btn v-on:click="deleteCharacter(character.id)"
                            >Delete</v-btn
                        >
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            classSkillsTemplate: [
                ...
                { skillName: 'Bluff', skillCode: 'BLF', isClassSkill: false },
                { skillName: 'Climb', skillCode: 'CLM', isClassSkill: false },
                { skillName: 'Craft', skillCode: 'CRA', isClassSkill: false },
                {
                    skillName: 'Diplomacy',
                    skillCode: 'DPM',
                    isClassSkill: false
                ...
                { skillName: 'Fly', skillCode: 'FLY', isClassSkill: false },
                {
                    skillName: 'Handle Animal',
                    skillCode: 'HDA',
                    isClassSkill: false
                },
                { skillName: 'Heal', skillCode: 'HEL', isClassSkill: false },
                {
                    skillName: 'Intimidate',
                    skillCode: 'ITD',
                    isClassSkill: false
                ...
                { skillName: 'Perform', skillCode: 'PRF', isClassSkill: false },
                {
                    skillName: 'Profession',
                    skillCode: 'PFN',
                    isClassSkill: false
                },
                { skillName: 'Ride', skillCode: 'RID', isClassSkill: false },
                {
                    skillName: 'Sense Motive',
                    skillCode: 'SMT',
                    isClassSkill: false
                ...
                { skillName: 'Stealth', skillCode: 'STL', isClassSkill: false },
                {
                    skillName: 'Survival',
                    skillCode: 'SRV',
                    isClassSkill: false
                },
                { skillName: 'Swim', skillCode: 'SWM', isClassSkill: false },
                {
                    skillName: 'Use Magic Device',
                    skillCode: 'UWM',
                    isClassSkill: false
    ...
    methods: {
        ...
        async deleteCharacter(id) {
            let response = await Api.delete('./api/character/delete', {
                id: id
            });
            this.getCharacters();
        },
    ...
    created: function() {
        ...
        this.characterSelect = JSON.parse(
            JSON.stringify(this.characterTemplate)
        );
    },
    computed: {
        skills: function() {
            ...
            for (i = 0; i < skills.length; i++) {
                for (j = 0; j < tempAbScores.length; j++) {
                    if (
                        tempAbScores[j].abilityCode == skills[i].abilityModType
                    ) {
                        skills[i].abilityMod = Math.floor(
                            (tempAbScores[j].abilityScore - 10) / 2
                        );
                    }
                }
